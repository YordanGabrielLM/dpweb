            ...
            <form id="frm_user" action="" method="">
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" maxlength="11" class="form-control" id="nro_identidad" name="nro_identidad">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" maxlength="130" class="form-control" id="razon_social" name="razon_social">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" maxlength="15" class="form-control" id="telefono" name="telefono">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="email" maxlength="100" class="form-control" id="correo" name="correo">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" maxlength="20" class="form-control" id="departamento" name="departamento">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" maxlength="30" class="form-control" id="provincia" name="provincia">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" maxlength="50" class="form-control" id="distrito" name="distrito">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" maxlength="150" class="form-control" id="direccion" name="direccion">
                        </div>
                    </div>
